...
class PermisosUsuarioForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            'puede_crear_plantillas': 'Mostrar u ocultar la sección Plantillas en la aplicación.',
            'puede_comparar_optimizaciones': 'Acceso a la herramienta Comparar optimizaciones.',
            'puede_crear_clientes': 'Gestión de clientes y enlaces relacionados.',
            'puede_crear_proyectos': 'Listado y detalle de proyectos.',
            'puede_crear_presupuestos': 'Presupuestos y generación de PDF.',
            'puede_crear_materiales': 'Catálogo de materiales / tableros.',
            'puede_ver_estadisticas': 'Página de estadísticas y exportaciones.',
            'puede_ver_historial_costos': 'Acceso al historial de costos.',
        }
