    ...
    if perfil.notificaciones_email:
        ...
        if email_destino:
            try:
                ...
                # Renderizar el email
                asunto = f"OptiCut - {titulo}"
                mensaje_email = render_to_string('opticut/emails/notificacion.txt', contexto)
                mensaje_email_html = render_to_string('opticut/emails/notificacion.html', contexto)
