...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.18.141']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'opticut' / 'templates'],  # Para páginas de error personalizadas
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'opticut.context_processors.tutorial_context',
            ],
        },
    },
]
...
# DEFAULT_FROM_EMAIL = 'OptiCut <noreply@opticut.com>'